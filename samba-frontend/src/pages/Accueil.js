...
const Accueil = () => {
    ...
    const [hoveredPropos, setHoveredPropos] = useState(null);
    ...
    useEffect(() => {
        ...
        styleSheet.innerText = `
            ...
            .modal-overlay { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.85); display: flex; align-items: center; justify-content: center; z-index: 2000; padding: 20px; backdrop-filter: blur(10px); }
            .modal-content { background: white; width: 100%; max-width: 1000px; max-height: 90vh; border-radius: 30px; overflow-y: auto; position: relative; animation: fadeInUp 0.4s ease-out; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.5); }
        `;
    ...
    const toutesDestinations = [
        { 
            ...
            capital: 'Libreville',
            desc: "Joyau de l'Afrique Centrale, le Gabon est couvert à 85% par la forêt tropicale. Bien que Libreville offre des infrastructures correctes, un déplacement vers Port-Gentil ou les parcs nationaux nécessite une vigilance sanitaire accrue, Le Gabon s’affirme comme le poumon stratégique de l’Afrique Centrale, où l’exploitation responsable des ressources rencontre une ambition écologique sans précédent, Au-delà de sa capitale Libreville, le pays déploie un potentiel industriel unique via la Zone Économique Spéciale de Nkok, tout en préservant son identité de Berceau de l'humanité grâce à ses treize parcs nationaux classés, Cette dualité entre développement urbain et jungle impénétrable impose une logistique rigoureuse : si les opportunités dans les secteurs du bois, des mines et de l'énergie sont florissantes, elles exigent une préparation minutieuse, tant sur le plan sanitaire que dans la gestion des déplacements vers les sites reculés.", 
        ...
        { 
            ...
            capital: 'Dakar',
            desc: "Le Sénégal attire pour Dakar et ses stations balnéaires. Les frais médicaux dans le secteur privé sont élevés pour les non-résidents, Porté par le Plan Sénégal Émergent (PSE), le pays transforme son paysage économique avec des projets d'envergure comme la ville nouvelle de Diamniadio et l'exploitation prochaine de ses gisements de gaz et de pétrole.", 
        ...
        { 
            ...
            capital: 'Abidjan',
            desc: "Puissance économique régionale. Les risques liés au paludisme et aux accidents justifient une couverture solide, Avec le déploiement massif d'infrastructures telles que le troisième pont ou le métro d'Abidjan, le pays attire les sièges sociaux des plus grandes multinationales et institutions financières africaines.", 
        ...
        { 
            ...
            capital: 'Paris',
            desc: "L'entrée dans l'espace Schengen impose une assurance voyage stricte avec une garantie minimale de 30 000 €, Au-delà de la simple formalité administrative pour l'obtention du visa, cette couverture doit impérativement inclure le rapatriement sanitaire et l'assistance médicale d'urgence, garantissant une prise en charge sans faille dans des systèmes de santé performants mais aux coûts particulièrement onéreux pour les visiteurs étrangers.", 
        ...
        { 
            ...
            capital: 'Yaoundé',
            desc: "Une grande diversité géographique qui nécessite une couverture pour les villes comme Douala et Yaoundé, Entre l'effervescence commerciale de Douala, poumon économique tourné vers l'Atlantique, et le calme institutionnel de Yaoundé, la cité aux sept collines, le pays offre un condensé d'opportunités dans l'agro-industrie, l'énergie et les infrastructures.", 
        ...
        { id: 6, pays: 'BENIN', zone: 'Afrique (CIMA)', img: imgBenin, capital: 'Cotonou', desc: "Destination culturelle puissante, Porté par une dynamique de réformes structurelles, le pays se transforme rapidement en un pôle touristique et économique majeur de l'Afrique de l'Ouest, avec des projets d'envergure comme la Cité internationale de l'innovation et du savoir et le développement de zones industrielles modernes à Glo-Djigbé.", pourquoi: "Protection contre les maladies tropicales et accidents.", points: ["Prise en charge Paludisme", "Rapatriement", "Perte de documents"] },
        { id: 7, pays: 'TOGO', zone: 'Afrique (CIMA)', img: imgTogo, capital: 'Lomé', desc: "Le Togo s'impose aujourd'hui comme l'escale d'affaires incontournable de l'Afrique de l'Ouest, portée par une vision stratégique qui transforme le pays en un véritable hub logistique et financier de premier plan. Grâce à son port en eau profonde unique dans la région et son aéroport ultra-moderne, le pays offre une connectivité sans pareille pour les investisseurs cherchant un accès direct au marché de la CEDEAO. Cette efficacité opérationnelle est soutenue par un climat des affaires en pleine mutation, marqué par des réformes audacieuses, une digitalisation accélérée des procédures et une stabilité politique rassurante. Entre infrastructures hôtelières de haut standing et dynamisme économique, le Togo ne se contente plus d'être une simple terre d'accueil, mais devient le partenaire de confiance où se dessinent les succès commerciaux de demain sur le continent.", pourquoi: "Assistance réactive à Lomé incluant la responsabilité civile.", points: ["Couverture médicale Lomé", "Responsabilité Civile", "Aide logistique"] },
        { id: 8, pays: 'BURKINA FASO', zone: 'Afrique (CIMA)', img: imgBurkinaFaso, capital: 'Ouagadougou', desc: "Destination culturelle au cœur du Sahel, Pays des « Hommes Intègres », il offre un dynamisme créatif unique et une hospitalité légendaire qui facilitent les échanges, malgré un contexte sécuritaire et climatique exigeant, Si Ouagadougou et Bobo-Dioulasso demeurent des centres d'affaires et d'artisanat vibrants, la situation géographique sahélienne impose une vigilance sanitaire stricte, notamment face aux pics de chaleur et aux risques infectieux saisonniers.", pourquoi: "Protection sanitaire à Ouagadougou et rapatriement garanti.", points: ["Urgences Ouagadougou", "Évacuation sanitaire", "Assistance rapatriement"] },
    ];
    ...
    return (
        <div style={styles.wrapper}>
            <nav style={styles.navbar}>
                ...
                <div style={styles.navLinks}>
                    {['a-propos', 'faq', 'contact'].map((item) => (
                        <button key={item} onClick={() => navigate(`/${item}`)} onMouseEnter={() => setHoverNavLink(item)} onMouseLeave={() => setHoverNavLink(null)} style={{ ...styles.textBtn, color: hoverNavLink === item ? '#39b54a' : '#475569', transform: hoverNavLink === item ? 'translateY(-2px)' : 'translateY(0)', transition: 'all 0.3s ease' }}>
                            {item === 'a-propos' ? 'À Propos' : item.toUpperCase()}
                        </button>
                    ))}
                    <button onClick={() => navigate('/suivi-client')} style={styles.btnNavAdmin}><Search size={16} /> SUIVI</button>
                    <button onClick={() => navigate('/espace-client')} onMouseEnter={() => setHoverBtnLogin(true)} onMouseLeave={() => setHoverBtnLogin(null)} style={{ ...styles.btnNavLogin, backgroundColor: hoverBtnLogin ? '#005a96' : '#0070bb', transform: hoverBtnLogin ? 'scale(1.05)' : 'scale(1)', transition: 'all 0.3s ease' }}>CLIENT ESPACE</button>
                </div>
            </nav>
            ...
            <header style={{...styles.hero, backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${imgSambaHero})`}}>
                <div className="animate-fade" style={styles.heroContent}>
                    <h1 style={styles.heroTitle}>Voyagez l'esprit tranquille avec <span style={{color: '#39b54a'}}> SAMB'A-VOYAGE </span></h1>
                    <p style={styles.heroSubtitle}>L'assurance voyage gabonaise qui vous accompagne partout dans le monde.</p>
            ...
            <section style={styles.sectionPortal}>
                {portails.map((p) => (
                    <div key={p.id} onMouseEnter={() => setHoveredCard(p.id)} onMouseLeave={() => setHoveredCard(null)} onClick={() => navigate(p.path)} style={{ ...styles.portalCard, border: `1px solid ${p.border}`, transform: hoveredCard === p.id ? 'translateY(-12px) scale(1.03)' : 'translateY(0)', boxShadow: hoveredCard === p.id ? `0 20px 40px rgba(0,0,0,0.15)` : '0 10px 20px rgba(0,0,0,0.08)', transition: 'all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}>
                        <div style={{ marginBottom: '15px' }}>{p.icon}</div>
                        <h3 style={{ fontSize: '18px', marginBottom: '10px' }}>{p.title}</h3>
                        <p style={{ fontSize: '13px', color: '#64748b' }}>{p.desc}</p>
                    </div>
                ))}
            </section>
            ...
            <section style={{...styles.section, background: '#fff'}}>
                <div style={styles.sectionHeader}>
                    <h2 style={{fontSize: '2rem', fontWeight: '800'}}>Découvrez les <span style={{color: '#39b54a'}}>destinations</span> populaires</h2>
            ...
            {paysSelectionne && (
                <div className="modal-overlay" onClick={() => setPaysSelectionne(null)}>
                    <div className="modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div style={{...styles.modalImgHeaderLarge, backgroundImage: `url(${paysSelectionne.img})`}}>
                            <div style={styles.modalImgOverlayLarge}>
                                <div style={{display: 'flex', flexDirection: 'column', gap: '10px'}}>
                                    ...
                                    <h2 style={{fontSize: '3.5rem', margin: 0, fontWeight: '800', textShadow: '2px 2px 10px rgba(0,0,0,0.5)'}}>
                                        {paysSelectionne.pays}
                                    </h2>
                                    <p style={{fontSize: '1.2rem', opacity: 0.9}}>Capitale : {paysSelectionne.capital}</p>
                                </div>
                            </div>
                        </div>
                        <div style={{padding: '40px 50px'}}>
                            <div style={{display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: '40px'}}>
                                <div>
                                    ...
                                    <p style={{lineHeight: '1.7', color: '#475569', fontSize: '1.05rem', marginBottom: '30px'}}>
            ...
            {/* --- SECTION POURQUOI NOUS CHOISIR (AVEC EFFETS ET MODALES) --- */}
            <section style={styles.section}>
                <div style={styles.sectionHeader}>
                    <h2 style={{fontSize: '2.5rem', fontWeight: '800'}}>Pourquoi nous choisir ?</h2>
                    <p style={{fontSize: '1.4rem', fontWeight: '800', color: '#424e5e', lineHeight: '1.6'}}> 
                ...
                <div style={styles.gridPropos}>
                    ...
                    <div 
                        ...
                        onClick={() => setAvantageSelectionne({
                            ...
                            text: "Depuis plus de 3 ans, SAMB'A-VOYAGE s'impose comme le leader de l'assurance voyage en ligne au Gabon. Nous travaillons en partenariat étroit avec les plus grands réseaux d'assistance mondiaux pour garantir que chaque contrat émis est reconnu par les ambassades.",
                    ...
                    >
                        <Shield size={40} color="#39b54a" />
                        <h3 style={{marginTop: '15px'}}>Fiabilité</h3>
                        <p>Plus de 3 ans d'expertise dans l'assurance au Gabon.</p>
                    ...
                    >
                        <Plane size={40} color="#0070bb" />
                        <h3 style={{marginTop: '15px'}}>Sérénité</h3>
                        <p>Une assistance disponible 24h/24 où que vous soyez.</p>
            ...
            {avantageSelectionne && (
                <div className="modal-overlay" onClick={() => setAvantageSelectionne(null)}>
                    <div className="modal-content" style={{maxWidth: '500px', padding: '40px', textAlign: 'center'}} onClick={e => e.stopPropagation()}>
                        <button style={styles.closeBtn} onClick={() => setAvantageSelectionne(null)}><X size={24}/></button>
                        <div style={{marginBottom: '20px'}}>{avantageSelectionne.icon}</div>
                        <h2 style={{color: '#1e293b', marginBottom: '15px'}}>{avantageSelectionne.title}</h2>
...
const styles = {
    ...
    btnNavLogin: { background: '#0070bb', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '25px', cursor: 'pointer', fontWeight: 'bold' },
    btnNavAdmin: { background: '#f1f5f9', color: '#1e293b', border: 'none', padding: '10px 20px', borderRadius: '25px', cursor: 'pointer', fontWeight: 'bold', display: 'flex', alignItems: 'center', gap: '8px' },
    hero: { height: '70vh', backgroundSize: 'cover', backgroundPosition: 'center', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: 'white' },
    heroContent: { maxWidth: '800px', padding: '20px' },
    heroTitle: { fontSize: '3rem', marginBottom: '20px', fontWeight: '800', lineHeight: '1.2' },
    ...
    sectionPortal: { display: 'flex', justifyContent: 'center', gap: '20px', padding: '0 5%', marginTop: '-80px', flexWrap: 'wrap', zIndex: 10, position: 'relative' },
    portalCard: { background: 'white', padding: '30px', borderRadius: '20px', width: '240px', cursor: 'pointer', textAlign: 'center' },
    section: { padding: '80px 10%' },
    sectionHeader: { textAlign: 'center', marginBottom: '60px' },
    gridPropos: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '40px' },
    cardPropos: { padding: '45px 30px', textAlign: 'center', background: 'white', borderRadius: '20px' },
    ...
    btnSavoirPlus: { background: 'none', border: 'none', color: '#39b54a', fontWeight: 'bold', display: 'flex', gap: '8px', cursor: 'pointer' },
    btnVoirTout: { background: '#0070bb', color: 'white', border: 'none', padding: '12px 30px', borderRadius: '10px', fontWeight: 'bold', cursor: 'pointer' },
    
    closeBtn: { position: 'absolute', top: '20px', right: '20px', background: 'rgba(0,0,0,0.3)', color: 'white', border: 'none', borderRadius: '50%', width: '40px', height: '40px', cursor: 'pointer', zIndex: 10, display: 'flex', alignItems: 'center', justifyContent: 'center', backdropFilter: 'blur(5px)' },
    modalImgHeaderLarge: { height: '450px', backgroundSize: 'cover', backgroundPosition: 'center', position: 'relative' },
    modalImgOverlayLarge: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: '40px 50px', background: 'linear-gradient(transparent, rgba(0,0,0,0.85))', color: 'white' },
    whySambaBlock: { background: '#f0fdf4', border: '1px solid #bbf7d0', padding: '20px', borderRadius: '15px', display: 'flex', gap: '15px' },
};
